...
const Zee5Detail: React.FC<Zee5DetailProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen pb-20 font-sans text-slate-900 animate-fade-in-up relative overflow-hidden pt-28">
      
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        
        {/* HERO SECTION */}
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 mb-20 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left animate-fade-in-up delay-100 order-2 lg:order-1">
                 {logoUrl && (
                     <div className="w-20 h-20 md:w-24 md:h-24 bg-white rounded-2xl shadow-lg flex items-center justify-center p-4 mb-8 border border-slate-100 transform hover:scale-105 transition-transform">
                 ...
                 <p className="text-slate-500 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl font-light">
                    {intro.p1}
                 </p>
                 ...
                 <div className="flex flex-wrap gap-4">
                     <button 
                        ...
                        className="bg-[#0056D2] text-white hover:bg-blue-700 font-bold py-4 px-8 rounded-full shadow-xl shadow-blue-500/20 transition-all flex items-center gap-2"
                     >
                         Start Campaign
                         <ArrowRight size={18} />
                     </button>
                     <button 
                        ...
                        className="bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 font-bold py-4 px-8 rounded-full transition-all"
                     >
                         Contact Sales
                     </button>
                 </div>
            ...
            <div className="lg:col-span-5 relative animate-fade-in-up delay-200 order-1 lg:order-2">
                 ...
                 <div className="grid grid-cols-2 gap-4 relative z-10">
                     ...
                     {/* Stat 1: Users */}
                     <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col items-center justify-center text-center h-48 hover:-translate-y-1 transition-transform duration-300 group">
                         ...
                         <div className="text-3xl font-bold text-slate-900">{header.monthlyUsers}</div>
                     ...
                     <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col items-center justify-center text-center h-48 hover:-translate-y-1 transition-transform duration-300 group">
                         ...
                         <div className="text-xl font-bold text-slate-900 uppercase">{header.platformType}</div>
                     ...
                     <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col items-center justify-center text-center h-48 hover:-translate-y-1 transition-transform duration-300 group">
                         ...
                         <div className="text-xl font-bold text-slate-900">{header.pricingModels}</div>
                     ...
                     <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 flex flex-col items-center justify-center text-center h-48 hover:-translate-y-1 transition-transform duration-300 group">
                         ...
                         <div className="text-xl font-bold text-slate-900">{header.categories}</div>
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-12 text-white flex flex-col md:flex-row items-center justify-between relative overflow-hidden mb-24 shadow-2xl">
             <div className="relative z-10 max-w-2xl">
                 <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Need a custom media plan?</h2>
                 <p className="text-slate-300 text-lg mb-8 font-light leading-relaxed">Our experts can help you mix and match formats to reach your specific target audience demographics effectively.</p>
                 <button 
                    onClick={() => setShowPopup(true)}
                    className="bg-white text-slate-900 hover:bg-blue-50 font-bold py-4 px-10 rounded-full uppercase text-sm tracking-widest transition-all shadow-lg transform hover:-translate-y-1"
                 >
                     Book Consultation
                 </button>
             </div>
             <div className="relative z-10 mt-10 md:mt-0">
                 <div className="w-40 h-40 bg-white/10 rounded-full flex items-center justify-center border border-white/20 backdrop-blur-md">
        ...
        <div className="max-w-4xl mx-auto">
             <h3 className="text-3xl font-bold mb-10 text-slate-900 text-center">Frequently Asked Questions</h3>
             <div className="grid gap-6">
                {adPlatform.faqs.map((faq, index) => (
                    <div key={faq.id} className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                        <h4 className="font-bold text-lg mb-3 text-slate-900">{faq.question}</h4>
                        <div className="space-y-2">
                            {faq.answer.map((ans, i) => (
                                <p key={i} className="text-slate-500 leading-relaxed">{ans}</p>
                            ))}
                        </div>
                    </div>
                ))}
