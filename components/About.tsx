...
const About: React.FC<AboutProps> = ({ onNavigate }) => {
  return (
    <div className="pt-24 md:pt-8 pb-20 px-6 md:px-12 max-w-[1400px] mx-auto bg-gray-50 min-h-screen flex flex-col font-sans animate-fade-in-up">
      {/* Breadcrumb */}
      <div className="text-sm text-slate-500 mb-8 md:mb-16 font-medium">
        <span 
      ...
      {/* Main Content Grid */}
      <div className="grid lg:grid-cols-12 gap-8 lg:gap-24 mb-16 md:mb-32">
        {/* Title Column */}
        <div className="lg:col-span-4 animate-fade-in-up delay-100">
          <h1 className="text-3xl md:text-6xl font-black text-slate-900 tracking-tighter leading-none mb-4 md:mb-0">
            About Us
          </h1>
        </div>
        ...
        <div className="lg:col-span-8 pt-2 animate-fade-in-up delay-200">
          <h2 className="text-lg md:text-xl text-slate-400 font-medium mb-4 md:mb-6">Who We Are</h2>
          
          <p className="text-slate-800 text-base md:text-xl leading-relaxed md:leading-loose font-normal text-left">
      ...
      <div className="mt-auto animate-fade-in-up delay-300">
        {/* Top Divider */}
        <div className="w-full border-t border-slate-900 mb-8 md:mb-10"></div>
        
        <h3 className="text-xl md:text-3xl font-bold text-slate-900 text-center mb-8 md:mb-10 px-4">
          Connect with us to explore your project's potential.
        </h3>
        
        {/* Bottom Divider */}
        <div className="w-full border-t border-slate-900 mb-10 md:mb-16"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-24 text-base">
           ...
           <div className="lg:col-span-4 flex flex-col gap-8 md:gap-12">
             {/* Office */}
             <div>
                <h4 className="font-bold text-slate-900 mb-2 md:mb-4 uppercase tracking-wider text-sm">OFFICE</h4>
             ...
             {/* Contact */}
             <div>
                <h4 className="font-bold text-slate-900 mb-2 md:mb-4 uppercase tracking-wider text-sm">CONTACT</h4>
           ...
           <div className="lg:col-span-8">
              {/* Social */}
              <div>
                <h4 className="font-bold text-slate-900 mb-2 md:mb-4 uppercase tracking-wider text-sm">SOCIAL</h4>
